  ...
  <div class="container">
    ...
    <form method="post" class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <textarea name="summary" id="summary-input" class="form-control" style="resize: vertical" rows="8" cols="80"
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" name="edu_year_<?= $index + 1 ?>" id="edu-year-<?= $index + 1 ?>-input"
                  class="form-control" value="<?= htmlentities($education['year']) ?>" readonly>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" name="edu_school_<?= $index + 1 ?>" id="edu-school-<?= $index + 1 ?>-input"
                  class="form-control school" value="<?= htmlentities($education['school']) ?>" readonly>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
            ...
            <div class="form-group" id="position-<?= $index + 1 ?>">
              ...
              <div class="col-sm-6">
                <textarea name="desc<?= $index + 1 ?>" id="desc-<?= $index + 1 ?>-input" class="form-control"
                  style="resize: vertical" rows="8" cols="80"
                  readonly><?= htmlentities($position['description']) ?></textarea>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
